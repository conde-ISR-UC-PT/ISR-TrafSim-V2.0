...
function [] = write_profile_isr_trafsim(tab,traj,car_feat,n)
    ...
    for i=1:size(tab,2)
        ...
        write_layer_isr_trafsim(round2(tab(1,i),0.01),traj(1,tab(2,i)),traj(2,tab(2,i)),traj(5,tab(2,i)),car_feat(5),n);
    end
